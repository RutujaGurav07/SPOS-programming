...
public class assemblerpass1 {
    public static void main(String[] args) {
        ...
        try {
            String inputfilename = "D:/Rutuja/programming/java progam/spos practicle/input.txt";
            fr = new FileReader(inputfilename);
            br = new BufferedReader(fr);

            String OUTPUTFILENAME = "D:/Rutuja/programming/java progam/spos practicle/OUTPUT/IC.txt";
            ...
            while ((sCurrentLine = br.readLine()) != null) {
                ...
                if (sCurrentLine.split(" |\\,").length > 3) { // if there are 4 words
                    ...
                    if (s.contains("=")) {
                        ...
                        symtab.putIfAbsent(s, "");
                        System.out.println("Symbol confusion s:"+s+"Symtab get value"+symtab.get(s));
                        int counter = 1;
                ...
                System.out.println("symptr:" + symptr);
            }

            String f1 = "D:/Rutuja/programming/java progam/spos practicle/OUTPUT/SYMTAB.txt";
            ...
            String f2 = "D:/Rutuja/programming/java progam/spos practicle/OUTPUT/LITTAB.txt";
            ...
            String f3 = "D:/Rutuja/programming/java progam/spos practicle/OUTPUT/POOLTAB.txt";
            FileWriter fw3 = new FileWriter(f3);
            BufferedWriter bw3 = new BufferedWriter(fw3);
            int poolcounter = 1;
            for (Integer item : pooltab) {
                bw3.write(poolcounter + "\t" + item + "\n");
